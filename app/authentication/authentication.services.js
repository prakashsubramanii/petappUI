...
angular.module('authenticationApp').factory('authenticationService', ['Base64', '$http', '$window', '$rootScope', '$cookies',
  function (Base64, $http, $window, $rootScope, $cookies) {
    ...
    service.signUp = function (userObj) {
      return $http({
        ...
        type: 'JSON',
        data: userObj,
        url: 'http://13.234.118.1:9090/PetPeers/api/user/'
      });
    }
    ...
    service.login = function (userobj) {
      ...
      return $http({
        method: 'GET',
        type: 'JSON',
        url: 'http://13.234.118.1:9090/PetPeers/api/user/authenticate'
      });
    }
